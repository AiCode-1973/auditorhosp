...
// Função para obter cor do badge do setor
function getBadgeColor($setor) {
    switch($setor) {
        case 'PA': return 'bg-green-100 text-green-800';
        case 'AMB': return 'bg-blue-100 text-blue-800';
        case 'PA/NC':
        case 'AMB/NC': return 'bg-red-100 text-red-800';
...
<div class="container mx-auto px-4 py-6 max-w-6xl">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Visualizar Documento PA/Ambulatório</h1>
        <div class="flex gap-2">
            <a href="documentos_pa_ambulatorio_form.php?id=<?php echo $id; ?>" class="bg-blue-600 text-white font-bold py-2 px-6 rounded hover:bg-blue-700 transition duration-150">
                Editar
            </a>
        ...
        <div class="md:col-span-1">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="text-sm font-medium text-gray-500">Setor</label>
                        <p>
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo getBadgeColor($doc['setor']); ?>">
