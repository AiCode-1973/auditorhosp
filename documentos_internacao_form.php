...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data_cadastro) || empty($convenio_id)) {
        $mensagem = "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4'>Preencha os campos obrigatÃ³rios.</div>";
    } else {
        try {
            if ($id) {
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form method="POST" enctype="multipart/form-data">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <!-- CompetÃªncia -->
                <div>
                    <label for="competencia" class="block text-sm font-medium text-gray-700 mb-1">CompetÃªncia *</label>
                ...
                <div class="md:col-span-2">
                    <label for="convenio_id" class="block text-sm font-medium text-gray-700 mb-1">ConvÃªnio *</label>
                ...
                <!-- ObservaÃ§Ãµes -->
                <div class="md:col-span-2">
                    <label for="observacoes" class="block text-sm font-medium text-gray-700 mb-1">ObservaÃ§Ãµes</label>
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-xs text-gray-500 mt-1">VocÃª pode selecionar mÃºltiplos arquivos</p>
                </div>
            </div>
