...
<div class="container mx-auto px-4 py-6 max-w-5xl">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="documentos.php" class="text-blue-600 hover:text-blue-800 font-medium">Voltar para Lista</a>
    </div>
    ...
    <?php else: ?>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">Informações do Documento</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Data</label>
                    <p class="text-base text-gray-900"><?php echo date('d/m/Y', strtotime($documento['data_cadastro'])); ?></p>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Competência</label>
                    <p class="text-base text-gray-900"><?php echo date('m/Y', strtotime($documento['competencia'])); ?></p>
                </div>
                
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-500 mb-1">Convênio</label>
                    <p class="text-base text-gray-900 font-semibold"><?php echo htmlspecialchars($documento['nome_convenio']); ?></p>
                </div>
                
                <?php if (!empty($documento['observacoes'])): ?>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-500 mb-1">Observações</label>
                        <p class="text-base text-gray-900 whitespace-pre-wrap"><?php echo htmlspecialchars($documento['observacoes']); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-4 border-b pb-2">
                ...
                <a href="documentos_form.php?id=<?php echo $id; ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1">
        ...
        <div class="flex justify-end gap-3 mt-6">
            <a href="documentos.php" class="bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600 transition duration-150">
                Voltar
            </a>
            <a href="documentos_form.php?id=<?php echo $id; ?>" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-150">
                Editar Documento
            </a>
        </div>
    <?php endif; ?>
